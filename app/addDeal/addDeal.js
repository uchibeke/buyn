...
angular.module('myApp.addDeal', ['ngRoute', 'ngStorage']).config(['$routeProvider',
function($routeProvider) {
	$routeProvider.when('/addDeal', {
		templateUrl : 'addDeal/addDeal.html',
		controller : 'addDealCtrl'
	});
}]).controller('addDealCtrl', ['$rootScope', '$scope', '$http', '$localStorage', '$timeout', '$interval', '$sce', '$firebaseObject', '$firebaseArray', '$firebaseAuth',
function($rootScope, $scope, $http, $localStorage, $timeout, $interval, $sce, $firebaseObject, $firebaseArray, $firebaseAuth) {
	...
	$scope.$storage.api.responses.productNameAnswer = {};
